...
<div class="dev-banner">Development Site<br/>skin file = LeftNav-Breadcrumbs-PageTitle.ascx<br/>width = <span id="site-width"></span></div>
...
<div id="LeftNav" class="site-wrapper">
		...
		<div class="content-area">
			...
			<div class="skin-width clearfix">
				...
				<div class="default-vertical">
					<h1 class="page-title left-offset"><dnn:TEXT runat="server" id="dnnTEXT" replaceTokens="true" CssClass="page-title" ShowText="[Tab:Title]" /></h1>
				</div>
